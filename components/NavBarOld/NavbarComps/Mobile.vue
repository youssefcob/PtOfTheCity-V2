...
<template>
   <a href="tel:+17186480888" aria-label="Call PT of the City at (718) 648-0888">
   <div :class="`icon-wrapper ${props.inverted? 'inverted':''} ${props.navOnLanding ? 'main' : 'secondary'} `">
       <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none" role="img" aria-label="Phone icon">
